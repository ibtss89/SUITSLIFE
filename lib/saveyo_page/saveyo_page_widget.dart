...
class SaveyoPageWidget extends StatefulWidget {
  const SaveyoPageWidget({Key key}) : super(key: key);

  @override
  _SaveyoPageWidgetState createState() => _SaveyoPageWidgetState();
}

class _SaveyoPageWidgetState extends State<SaveyoPageWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final saveyoPageUsersRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
                  ...
                  child: Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          saveyoPageUsersRecord.displayName,
